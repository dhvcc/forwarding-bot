...
class DataConfig:
    def __init__(self):
        ...
        self.group_token: str = None
        self.destination_id: int = None
    ...
    def load_environ(self, environment):
        ...
        if self.destination_id is None:
            self.destination_id = int(environment.get("FORWARDING_BOT_DESTINATION_ID"))

        if self.source_id is None:
            self.source_id = int(environment.get("FORWARDING_BOT_SOURCE_ID"))
